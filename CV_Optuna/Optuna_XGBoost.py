...
if __name__ == "__main__":
    ...
    for idx_folder, specific_folder_name in enumerate(selected_list):
        ...
        print(f'{idx_folder+1}. Running XGBoost for file from {specific_folder_name}:', '\n')  
        ...
        tuning_result_row = [specific_folder_name, 'XGBoost'] + best_result + [trial.number, trial.params] + para_value_list
